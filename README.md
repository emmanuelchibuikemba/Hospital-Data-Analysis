...
A detailed storytelling report containing the SQL findings, Power BI dashboard analysis, recommendations, and supporting visuals is available below:

[View the Hospital Patient Analytics Report](report/hospital_patient_analytics_report.pdf)
...
| `images/` | [Dashboard Screenshot](images/hospital_patient_analyticss_dashboard.png) | Final Hospital Patient Analytics Dashboard |
